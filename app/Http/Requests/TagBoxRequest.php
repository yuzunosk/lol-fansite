...
class TagBoxRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'chanpion_tag_id_1'  => 'required|string|max:50',
            'chanpion_tag_id_2'  => 'nullable|string|max:50',
            'chanpion_tag_id_3'  => 'nullable|string|max:50',
            'chanpion_tag_id_4'  => 'nullable|string|max:50',
            'chanpion_tag_id_5'  => 'nullable|string|max:50',
            'chanpion_tag_id_6'  => 'nullable|string|max:50',
            'chanpion_tag_id_7'  => 'nullable|string|max:50',
            'chanpion_tag_id_8'  => 'nullable|string|max:50',
            'chanpion_tag_id_9'  => 'nullable|string|max:50',
            'chanpion_tag_id_10' => 'nullable|string|max:50',
        ];
    }
