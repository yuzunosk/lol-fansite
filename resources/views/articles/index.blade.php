        ...
        <div class="col-md-10">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-dark p-2">
                      <img src="@if($articleData->img){{ asset('storage/'.$articleData->img) }}@else{{ asset('storage/img/etc/img_no.png') }} @endif" class="card-img"
                      style="position:relative;height:200px;object-fit:cover">
