        ...
        <div class="col-md-8">
            <div class="card">
                    ...
                    <form method="POST" action="{{ route('tagbox.update', $tagBoxData->chanpion_id) }}">
                        ...
                        <div class="container mt-4">
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $tagBoxData->name) }}" autocomplete="name" readonly autofocus>
                        ...
                        <div class="container mt-4">
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    <input id="chanpion_id" type="text" class="form-control @error('chanpion_id') is-invalid @enderror" name="chanpion_id" value="{{ old('chanpion_id', $tagBoxData->chanpion_id) }}" autofocus readonly>
                        ...
                        @for ($i = 1; $i <= 10; $i++) <div class="container">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-5">
                                    <select name="chanpion_tag_id_{{$i}}" id="select-tags" class="form-control text-center @error('chanpion_tag_id_'.($i)) is-invalid @enderror">
                ...
                <div class="container text-center mt-4">
                    <div class="form-group row">
                        <div class="col">
                            <button type="submit" class="btn btn-info border-dark px-5">
                                {{ __('Register') }}
                            </button>
                        </div>
                    </div>
