            ...
            <div v-show="!loading">
                ...
                <div class="l_header">
                    ...
                    <div :class="jsFloatMenuTurget">
                        <HeaderLink :id="linkDatas[0].id" :data="linkDatas[0]">
                        </HeaderLink>

                        <HeaderLink :id="linkDatas[1].id" :data="linkDatas[1]">
                        </HeaderLink>

                        <HeaderLink :id="linkDatas[2].id" :data="linkDatas[2]">
                        </HeaderLink>

                        <HeaderLink :id="linkDatas[3].id" :data="linkDatas[3]">
                        </HeaderLink>
                    </div>
                        ...
                        <div class="c-news__header">
                            <div class="c-news-head-unit">
                                <h2 class="c-news-head-unit__title">
                                    更新情報<span
                                        class="c-news-head-unit__subTitle"
                                        >NEWS</span
                                    >
                                </h2>
                            </div>
                            <button
                                @click="clickUpdateNews"
                                class="c-news__header__btn"
                                type="button"
                            >
                                <span>一覧を見る</span>
                            </button>
                        ...
                        <div class="c-footer-container-header">
                            <div class="logo__unit">
                                <img
                                    ...
                                    src="/storage/img/logo/lol_logo.png"
                                    alt=""
                                />
                            </div>
                        </div>
