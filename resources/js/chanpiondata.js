            ...
            chanpionDatas: [
                {
                    ...
                    feature:
                        "2種類のBlinkを使い分ける、魔法ダメージが主体のAssassin。槍使いの例に漏れず通常攻撃の射程も長め",
                    roll: "Assassin",
                    subRoll: "Mage",
                    beCost: "4800",
                    rpCost: "880",
                    ...
                    skills: [
                        ...
                        },
                        {
                            ...
                            text:
                                "指定の敵ユニットの方向に突き抜るようにリープし、対象にAAと追加魔法DMを与える。通常攻撃なので当然On-hit-effectも有効。但しクリティカルは発生しない。使用と同時に射程外へflashされたりすると回避される。対象を突き抜ける前は薄い壁であれば通り抜けることも可能。敵チャンピオンを指定して攻撃する用途の他、後ろにミニオンを残った状況なら逃走にも利用できる。"
                        },
                        {
                            id: "W",
                ...
                },
                {
                    ...
                    feature:
                        "3段Leapや低CDの加速スキルにより非常に高い機動力を持つMage/Assassin、バーストダメージは少し低め",
                    roll: "Mage",
                    subRoll: "Assassin",
                    beCost: "4800",
                    rpCost: "880",
                    ...
                    skills: [
                        {
                            ...
                            text:
                                "1.5秒以内に敵チャンピオンにスキルを2回当てた場合、MSが増加する。"
                        },
                        {
                            id: "Q",
                        ...
                        },
                        {
                            ...
                            text:
                                "敵Championを優先的に狙わせるには一定距離まで近付く必要がある。表示されている射程は周囲を回る鬼火からの射程でありAhri本体からの距離ではないので注意。ほぼノーモーションで歩きながら使えるため攻めや逃げでも使いやすい。それぞれの弾の対象はあくまで単数なため、Spell Vampなどの効果は単体扱いとなる。"
                        },
                        {
                            id: "E",
                            name: ["チャーム", "Charm"],
                            ...
                            text:
                                "Ahriのコンボの起点。全てはこのキッスが当たってから始まる。魅了状態は画面上に「Taunted!」と表示される。Tauntと違い自分に攻撃させる効果はないため、Rangedの敵Championも安定して引き寄せる事が出来る。TenacityやCC除去効果は有効。Champion以外にも当たるので、Lane戦ではMinionを盾にされると非常に当てづらい。"
                        },
                        {
                            id: "R",
                            ...
                            text:
                                "指定方向にリープし、敵チャンピオンを優先とした付近の敵ユニット3体までに魔法DMを与える。魔法DMは同一対象にはスキル使用毎に一度しか発動しない。このスキルは使用後10秒以内は最大2回までCost無しで追加使用できる"
                        }
                    ],
                    tagLists: [
                        { name: "ブリンク持ち", subname: "blink" },
                ...
                },
                {
                    ...
                    popularName: "砕けぬ槍",
                    feature:
                        "強固な盾と槍を使いこなすガチンコファイター。対象指定スタンと超長距離Blinkによる恐怖のGankが持ち味",
                    roll: "Fighter",
                    subRoll: "Assassin",
                    beCost: "3150",
                    rpCost: "790",
                    ...
                    skills: [
                        {
                            ...
                            text:
                                "AAかスキル使用毎に1スタック増加し(最大5スタック)、最大スタック時の偉大なる星路(R)以外のスキル使用時に全スタック消費してスキルが強化される。"
                        },
                        {
                            id: "Q",
                            ...
                            text:
                                "消費マナ、CD、威力、射程のバランスが非常に優れている優秀なスキル。タップでの発動はCDが半分になるシンプルな前方範囲攻撃で、メインダメージソース。ハラスや中立狩りのメインにも幅広く活用できるが、連発すると簡単にマナが枯渇する。長押しするとレンジは伸びるが、最初に当たったユニット以外にはダメージが半減する。"
                        },
                        {
                            id: "W",
                            ...
                            text:
                                "飛びつき＋スタンなので確実に捉えることが出来る。だが飛びつき可能距離はさほど長くなく読まれやすい、CDも短くない上に、無暗に使うとガンクに非常に弱くなるので注意。また発動してからフラッシュ等のブリンクを使われると、相手はブリンク先でスタンする。強化版は直後に行うAAが3連撃になり、ダメージは半分(計150%)になるがパッシブ等のスタックやOnHitは3回発動する。 この為多くのキーストーンやスタック系のアイテムと相性が良い。ただしタワーには発動しない。"
                        },
                        {
                            id: "E",
                            ...
                            text:
                                "指定方向に1.5秒間盾を構え、自身に移動方向に応じたSlow(0～50%)を付与し、盾を向けた方向からの敵タワーを含む敵ユニットからのDMを全て無効化する。また、その間盾を向けた方向を槍で扇状に連続で突き、範囲内の敵ユニットに0.125秒毎に物理DMを与える。"
                        },
                        {
                            id: "R",
                            ...
                            text:
                                "2秒詠唱後に対象指定不可状態で空中に飛び上がり、その2.4秒後に指定地点に向かって斜めに落下(テレポート)して周囲の敵ユニットに魔法DMを与え、定命の意志のスタックが最大になる。基本はGank用だが、体力に余裕があり敵がハードCCを持っていなければ逃げに使えなくも無い。攻撃スキルではあるものの物理攻撃力が乗らずダメージは控えめになりがち、移動・敵の足止め用と割り切ってダメージは期待しない事。"
                        }
                    ],
                    tagLists: [
                        { name: "ブリンク持ち", subname: "blink" },
                ...
                },
                {
                    ...
                    popularName: "堕天の高潔",
                    feature:
                        "サポートタグが付いているとは思えない火力を誇るNuker、燃費は悪いが全てのスキルが高性能",
                    roll: "Mage",
                    subRoll: "Support",
                    beCost: "1350",
                    rpCost: "585",
                ...
                },
                {
                    ...
                    popularName: "盲目の修行僧",
                    feature:
                        "2種類のLeapによりJungler屈指の機動力を持つ、高難易度チャンピオン高いプレイヤースキルが要求される",
                    roll: "Fighter",
                    subRoll: "Assasin",
                    beCost: "4800",
                    rpCost: "880",
                ...
                },
                {
                    ...
                    popularName: "極北の激憤",
                    feature:
                        "豊富なCCを持ち、更にスロー耐性も所持しているTank、Passhive発動中は非常に硬い",
                    roll: "Tank",
                    subRoll: "Fighter",
                    beCost: "4800",
                    rpCost: "880",
